  ...
  {{-- Navbar --}}
    <nav id="navbar" class="flex items-center justify-between py-3 px-8 sm:py-3 sm:px-14 sticky top-0 z-10 sm:flex-auto lg:flex">
      ...
      <div class="toggle hidden md:flex w-5/6 text-right text-bold mt-5 md:mt-0 border-t-2 border-gray-400 md:border-none">
        <a href="{{ url('/') }}" class="{{ request()->path() === '/' ? 'text-black border-black' : 'text-gray-400 border-gray-400' }} block md:inline-block hover:text-black md:hover:border-black px-3 py-3 border-b-2 md:border-transparent transition-all font-bold">HOME</a>
        <a href="{{ url('classes') }}" class="{{ request()->path() === 'classes' ? 'text-black border-black' : 'text-gray-400 border-gray-400' }} block md:inline-block  hover:text-black hover:border-black px-3 py-3 border-b-2  md:border-transparent transition-all font-bold">CLASSES </a>
