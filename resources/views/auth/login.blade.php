          ...
          <div id="auth-left">
              ...
              <form action="" method="POST">
                ...
                @method('POST')
                  ...
                  <div class="form-group position-relative has-icon-left mb-4">
                      <input type="password" name="password" class="form-control form-control-xl" value="" placeholder="Password">
                      <div class="form-control-icon">
              ...
              <div class="text-center mt-5 text-lg fs-4">
                  <p style="color: #a9949c;">Don't have an account? <a href="" style="color: #d30c55;"
